...
### Description
For this milestone I mainly worked on the electronics for my Hexabee. I got the OLED display up and running so it could show live sensor data, and started wiring in the ultrasonic sensor so it could detect distance. While I was doing this, my ESP Wifi module started heating up and eventually just stopped working. I used a multimeter to test the voltages, but everything looked normal, so we figured it was something internal shorting out. I ended up just removing the wifi module completely and switched to using the physical remote control instead of the processing app. Since I couldn't get live data over wifi anymore, I added a DHT11 temperature and humidity sensor instead so I could still collect and show data on the OLED. Alongside all of this, I was also CADing the outer bee shell and battery holder, measuring the hexapod base to make sure everything would actually line up, and prototyping a hook joint to attach the shell onto the base.

![Hexapod Base Image](HexapodBase.png)

![Hexapod Bee Image](HexapodBee.png)

### Challenges
Getting the ultrasonic sensor to actually work was a pain because of a bunch of code conflicts with the existing hexapod library. Losing the wifi module was also annoying since I didn't expect it, and it took a while of testing with the multimeter before we just concluded it was an internal short. That also meant scrapping my original idea of pulling live weather data over wifi, so I had to pivot to the DHT11 sensor instead.
...
| IR Receiver | Receive signals from IR control | $0.79 USD per piece| <a href="amazon.com/Hosyond-inches-Display-SSD1309-Arduino/dp/B0G2RFLG1L/ref=sr_1_16?crid=1QK6QTJ7NNG4J&dib=eyJ2IjoiMSJ9.wmW83Dmxfyl5RxdfjV1gHhrQDxOQEy9Lug9kAuw9ga46H8Tq8_7f86glMLI09wU_MYoGCRJqDgI5gJEdC8fP9NP5d9igh5UQybORTbqPjTDyYZ4tyrjOYcZ8iPmFEsU5b2C6VLENHtvfgNNIl-KY_qE36cSSQ47_pO7QiMCHY3kX6VGsGz2Dr8l95xZ4cZBVnZDHKw_56SzjAKRDhCpJyjwIje7R_SLxMIOr9r10LqA._ZYLdrnNCDxEpPCu6QxCYQd1G_Fpp7kKCu1FxV7sTbc&dib_tag=se&keywords=OLED+module&qid=1785437409&sprefix=oled+module%2Caps%2C231&sr=8-1](https://www.amazon.com/Receiver-Remote-Infrared-Module-TSOP4838/dp/B0DR8CRK3Y/ref=sr_1_9_sspa?crid=1VHIUKBZ4WVGV&dib=eyJ2IjoiMSJ9.ULBZKO_xr0zGu6AU8xKHYZXHeOWskTEasBm7znZUT8oShhhV3lRdlG72d4B3BDBezsCQJyAPEb-K57n1LmWeEyKiTBDzMsl3QVyQBRPWrnZZZBkcIKBvAS7bkeyi1zWHJpj